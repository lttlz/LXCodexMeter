...
Function .onInit
  ...
  !if "${DISPLAYLANGUAGESELECTOR}" == "true"
    ; Force the language selector to show every time by clearing any previously
    ; remembered language choice. MUI_LANGDLL_DISPLAY otherwise reuses the
    ; registry value and skips the dialog entirely (looks like "English only").
